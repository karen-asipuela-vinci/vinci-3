...
import validation.ChaineValidation;
...
public class MainClient {
	public static void main(String[] args) throws IOException {
		...
		ChaineValidation chaineValidation = new ChaineValidation();
		try {
			...
			while (fichier.hasNextLine()) {
				try {
					...
					CarteDeCredit carteDeCredit = chaineValidation.valider(parts[0], dateExpiration, parts[2]);
